 ...
 */
public class EnglishNormalizationAnalyzer extends StopwordAnalyzerBase {
   ...
   */
  public EnglishNormalizationAnalyzer(Version matchVersion) {
   ...
   */
  public EnglishNormalizationAnalyzer(Version matchVersion, CharArraySet stopwords) {
