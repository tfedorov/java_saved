 ...
 */
public final class LatvianNormalizationAnalyzer extends StopwordAnalyzerBase {
  ...
  private static class DefaultSetHolder {
    ...
    static {
      try {
        DEFAULT_STOP_SET =
            WordlistLoader.getWordSet(IOUtils.getDecodingReader(LatvianAnalyzer.class,
   ...
   */
  public LatvianNormalizationAnalyzer(Version matchVersion) {
   ...
   */
  public LatvianNormalizationAnalyzer(Version matchVersion, CharArraySet stopwords) {
