 ...
 * <a name="version"/>
 * <p>
 * You must specify the required {@link Version} compatibility when creating SpanishAnalyzer:
 * <ul>
 * <li>As of 3.6, SpanishLightStemFilter is used for less aggressive stemming.
 * </ul>
 */
public final class SpanishNormalizationAnalyzer extends StopwordAnalyzerBase {
   ...
   */
  public SpanishNormalizationAnalyzer(Version matchVersion) {
   ...
   */
  public SpanishNormalizationAnalyzer(Version matchVersion, CharArraySet stopwords) {
