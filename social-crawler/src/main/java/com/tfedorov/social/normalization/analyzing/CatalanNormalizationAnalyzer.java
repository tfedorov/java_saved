 ...
 * <ul>
 * <li>As of 3.6, ElisionFilter with a set of Catalan contractions is used by default.
 * </ul>
 */
public final class CatalanNormalizationAnalyzer extends StopwordAnalyzerBase {
  ...
  private static final CharArraySet DEFAULT_ARTICLES = CharArraySet
      .unmodifiableSet(new CharArraySet(Version.LUCENE_CURRENT, Arrays.asList("d", "l", "m", "n",
          "s", "t"), true));
   ...
   */
  public CatalanNormalizationAnalyzer(Version matchVersion) {
   ...
   */
  public CatalanNormalizationAnalyzer(Version matchVersion, CharArraySet stopwords) {
