 ...
 * </p>
 */
public final class BrazilianNormalizationAnalyzer extends StopwordAnalyzerBase {
  ...
  private static class DefaultSetHolder {
    ...
    static {
      try {
        DEFAULT_STOP_SET =
            WordlistLoader.getWordSet(IOUtils.getDecodingReader(BrazilianAnalyzer.class,
   ...
   */
  public BrazilianNormalizationAnalyzer(Version matchVersion) {
   ...
   */
  public BrazilianNormalizationAnalyzer(Version matchVersion, CharArraySet stopwords) {
   ...
   *         {@link StandardTokenizer} filtered with {@link LowerCaseFilter}, {@link StandardFilter}
   *         , {@link StopFilter} , and {@link BrazilianStemFilter}.
   */
  @Override
