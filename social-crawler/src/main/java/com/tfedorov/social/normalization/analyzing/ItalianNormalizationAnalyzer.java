 ...
 * <li>As of 3.2, ElisionFilter with a set of Italian contractions is used by default.
 * </ul>
 */
public final class ItalianNormalizationAnalyzer extends StopwordAnalyzerBase {
  ...
  private static final CharArraySet DEFAULT_ARTICLES = CharArraySet
      .unmodifiableSet(new CharArraySet(Version.LUCENE_CURRENT, Arrays.asList("c", "l", "all",
   ...
   */
  public ItalianNormalizationAnalyzer(Version matchVersion) {
   ...
   */
  public ItalianNormalizationAnalyzer(Version matchVersion, CharArraySet stopwords) {
   ...
   *         exclusion set is provided and {@link ItalianLightStemFilter}.
   */
  @Override
