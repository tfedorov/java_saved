 ...
 */
public final class DanishNormalizationAnalyzer extends StopwordAnalyzerBase {
   ...
   */
  public DanishNormalizationAnalyzer(Version matchVersion) {
   ...
   */
  public DanishNormalizationAnalyzer(Version matchVersion, CharArraySet stopwords) {
