 ...
 * <li>As of 3.1, Snowball stemming is done with SnowballFilter, and Snowball stopwords are used by
 * default.
 ...
 * </p>
 */
public final class GermanNormalizationAnalyzer extends StopwordAnalyzerBase {

  /** @deprecated in 3.1, remove in Lucene 5.0 (index bw compat) */
  @Deprecated
  private final static String[] GERMAN_STOP_WORDS = {"einer", "eine", "eines", "einem", "einen",
      "der", "die", "das", "dass", "da√Я", "du", "er", "sie", "es", "was", "wer", "wie", "wir",
      "und", "oder", "ohne", "mit", "am", "im", "in", "aus", "auf", "ist", "sein", "war", "wird",
      "ihr", "ihre", "ihres", "als", "f√Љr", "von", "mit", "dich", "dir", "mich", "mir", "mein",
      "sein", "kein", "durch", "wegen", "wird"};
  ...
  private static class DefaultSetHolder {
    ...
    private static final CharArraySet DEFAULT_SET_30 = CharArraySet
        .unmodifiableSet(new CharArraySet(Version.LUCENE_CURRENT, Arrays.asList(GERMAN_STOP_WORDS),
            false));
   ...
   */
  public GermanNormalizationAnalyzer(Version matchVersion) {
   ...
   */
  public GermanNormalizationAnalyzer(Version matchVersion, CharArraySet stopwords) {
   ...
   *         {@link GermanNormalizationFilter} and {@link GermanLightStemFilter}
   */
  @Override
