 ...
 */
public final class RomanianNormalizationAnalyzer extends StopwordAnalyzerBase {
  ...
  private static class DefaultSetHolder {
    ...
    static {
      try {
        DEFAULT_STOP_SET =
            loadStopwordSet(false, RomanianAnalyzer.class, DEFAULT_STOPWORD_FILE, STOPWORDS_COMMENT);
   ...
   */
  public RomanianNormalizationAnalyzer(Version matchVersion) {
   ...
   */
  public RomanianNormalizationAnalyzer(Version matchVersion, CharArraySet stopwords) {
