 ...
 * </p>
 */
public final class GreekNormalizationAnalyzer extends StopwordAnalyzerBase {
   ...
   * 
   * @param matchVersion Lucene compatibility version, See <a href="#version">above</a>
   */
  public GreekNormalizationAnalyzer(Version matchVersion) {
   ...
   */
  public GreekNormalizationAnalyzer(Version matchVersion, CharArraySet stopwords) {
   ...
   *         {@link StandardTokenizer} filtered with {@link GreekLowerCaseFilter},
   *         {@link StandardFilter}, {@link StopFilter}, and {@link GreekStemFilter}
   */
  @Override
