 ...
 */
public final class HungarianNormalizationAnalyzer extends StopwordAnalyzerBase {
   ...
   */
  public HungarianNormalizationAnalyzer(Version matchVersion) {
   ...
   */
  public HungarianNormalizationAnalyzer(Version matchVersion, CharArraySet stopwords) {
