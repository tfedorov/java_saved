 ...
 */
public final class SwedishNormalizationAnalyzer extends StopwordAnalyzerBase {
   ...
   */
  public SwedishNormalizationAnalyzer(Version matchVersion) {
   ...
   */
  public SwedishNormalizationAnalyzer(Version matchVersion, CharArraySet stopwords) {
