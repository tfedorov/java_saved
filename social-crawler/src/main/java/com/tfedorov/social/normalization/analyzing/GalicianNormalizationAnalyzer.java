 ...
 */
public final class GalicianNormalizationAnalyzer extends StopwordAnalyzerBase {
  ...
  private static class DefaultSetHolder {
    ...
    static {
      try {
        DEFAULT_STOP_SET =
            WordlistLoader.getWordSet(IOUtils.getDecodingReader(GalicianAnalyzer.class,
   ...
   */
  public GalicianNormalizationAnalyzer(Version matchVersion) {
   ...
   */
  public GalicianNormalizationAnalyzer(Version matchVersion, CharArraySet stopwords) {
