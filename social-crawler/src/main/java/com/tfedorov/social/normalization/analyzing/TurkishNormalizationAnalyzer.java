 ...
 */
public final class TurkishNormalizationAnalyzer extends StopwordAnalyzerBase {
   ...
   */
  public TurkishNormalizationAnalyzer(Version matchVersion) {
   ...
   */
  public TurkishNormalizationAnalyzer(Version matchVersion, CharArraySet stopwords) {
   ...
   *         {@link TurkishLowerCaseFilter}, {@link StopFilter}, {@link KeywordMarkerFilter} if a
