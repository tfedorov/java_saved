 ...
 * <p>
 * This analyzer implements light-stemming as specified by: <i> Searching Strategies for the
 * Bulgarian Language </i> http://members.unine.ch/jacques.savoy/Papers/BUIR.pdf
 * <p>
 */
public final class BulgarianNormalizationAnalyzer extends StopwordAnalyzerBase {
  /**
   ...
   */
  public BulgarianNormalizationAnalyzer(Version matchVersion) {
   ...
   */
  public BulgarianNormalizationAnalyzer(Version matchVersion, CharArraySet stopwords) {
    this(matchVersion, stopwords, CharArraySet.EMPTY_SET);
  }

  /**
   * Builds an analyzer with the given stop words and a stem exclusion set. If a stem exclusion set
   * is provided this analyzer will add a {@link KeywordMarkerFilter} before
