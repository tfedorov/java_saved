 ...
 * <a name="version"/>
 * <p>
 * You must specify the required {@link Version} compatibility when creating PortugueseAnalyzer:
 * <ul>
 * <li>As of 3.6, PortugueseLightStemFilter is used for less aggressive stemming.
 * </ul>
 */
public final class PortugueseNormalizationAnalyzer extends StopwordAnalyzerBase {
   ...
   */
  public PortugueseNormalizationAnalyzer(Version matchVersion) {
   ...
   */
  public PortugueseNormalizationAnalyzer(Version matchVersion, CharArraySet stopwords) {
   ...
   *         and {@link PortugueseLightStemFilter}.
   */
  @Override
