 ...
 */
public final class ArmenianNormalizationAnalyzer extends StopwordAnalyzerBase {
   ...
   */
  public ArmenianNormalizationAnalyzer(Version matchVersion) {
   ...
   */
  public ArmenianNormalizationAnalyzer(Version matchVersion, CharArraySet stopwords) {
