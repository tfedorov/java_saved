 ...
 */
public final class BasqueNormalizationAnalyzer extends StopwordAnalyzerBase {
   ...
   */
  public BasqueNormalizationAnalyzer(Version matchVersion) {
   ...
   */
  public BasqueNormalizationAnalyzer(Version matchVersion, CharArraySet stopwords) {
