 ...
 */
public final class IndonesianNormalizationAnalyzer extends StopwordAnalyzerBase {
   ...
   */
  public IndonesianNormalizationAnalyzer(Version matchVersion) {
   ...
   */
  public IndonesianNormalizationAnalyzer(Version matchVersion, CharArraySet stopwords) {
    this(matchVersion, stopwords, CharArraySet.EMPTY_SET);
  }

  /**
   * Builds an analyzer with the given stop word. If a none-empty stem exclusion set is provided
   * this analyzer will add a {@link KeywordMarkerFilter} before {@link IndonesianStemFilter}.
   * 
   * @param matchVersion lucene compatibility version
   * @param stopwords a stopword set
  ...
  protected TokenStreamComponents createComponents(String fieldName, Reader reader) {
    ...
    if (!stemExclusionSet.isEmpty()) {
      return new TokenStreamComponents(source, new KeywordMarkerFilter(result, stemExclusionSet));
    }
