 ...
 * <a name="version"/>
 * <p>
 * You must specify the required {@link Version} compatibility when creating HindiAnalyzer:
 * <ul>
 * <li>As of 3.6, StandardTokenizer is used for tokenization
 * </ul>
 */
public final class HindiNormalizationAnalyzer extends StopwordAnalyzerBase {
   ...
   */
  public HindiNormalizationAnalyzer(Version version, CharArraySet stopwords,
   ...
   */
  public HindiNormalizationAnalyzer(Version version) {
   ...
   *         {@link IndicNormalizationFilter}, {@link HindiNormalizationFilter},
