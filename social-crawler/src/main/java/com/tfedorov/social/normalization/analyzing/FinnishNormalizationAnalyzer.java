 ...
 */
public final class FinnishNormalizationAnalyzer extends StopwordAnalyzerBase {
   ...
   */
  public FinnishNormalizationAnalyzer(Version matchVersion) {
   ...
   */
  public FinnishNormalizationAnalyzer(Version matchVersion, CharArraySet stopwords) {
