...
import com.tfedorov.social.normalization.ZHConverter;
 ...
 * </p>
 * <p>
 * Segmentation is based upon the <a href="http://en.wikipedia.org/wiki/Hidden_Markov_Model">Hidden
 * Markov Model</a>. A large training corpus was used to calculate Chinese word frequency
 * probability.
 * </p>
 * <p>
 * This analyzer requires a dictionary to provide statistical data. SmartChineseAnalyzer has an
 * included dictionary out-of-box.
 * </p>
 * <p>
 * The included dictionary data is from <a href="http://www.ictclas.org">ICTCLAS1.0</a>. Thanks to
 * ICTCLAS for their hard work, and for contributing the data under the Apache 2 License!
 * </p>
 * 
 * @lucene.experimental
 */
public final class ChineseNormalizationAnalyzer extends Analyzer {
  ...
  private static class DefaultSetHolder {
    ...
    static CharArraySet loadDefaultStopWordSet() throws IOException {
      ...
      return CharArraySet.unmodifiableSet(WordlistLoader.getWordSet(IOUtils.getDecodingReader(
          SmartChineseAnalyzer.class, DEFAULT_STOPWORD_FILE, IOUtils.CHARSET_UTF_8),
   ...
   */
  public ChineseNormalizationAnalyzer(Version matchVersion) {
   ...
   * </p>
   * <p>
   * The included default stopword list is simply a list of punctuation. If you do not use this
   * list, punctuation will not be removed from the text!
   * </p>
   * 
   * @param useDefaultStopWords true to use the default stopword list.
   */
  public ChineseNormalizationAnalyzer(Version matchVersion, boolean useDefaultStopWords) {
   ...
   */
  public ChineseNormalizationAnalyzer(Version matchVersion, CharArraySet stopWords) {
  ...
  public TokenStreamComponents createComponents(String fieldName, Reader reader) {
    //
    reader = new StringReader(ZHConverter.convert(reader, 1));
    //
