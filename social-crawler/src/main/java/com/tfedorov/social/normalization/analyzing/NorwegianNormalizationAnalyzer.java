 ...
 */
public final class NorwegianNormalizationAnalyzer extends StopwordAnalyzerBase {
   ...
   */
  public NorwegianNormalizationAnalyzer(Version matchVersion) {
   ...
   */
  public NorwegianNormalizationAnalyzer(Version matchVersion, CharArraySet stopwords) {
