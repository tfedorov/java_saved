 ...
 * <p>
 * This analyzer implements light-stemming as specified by: <i> Light Stemming for Arabic
 ...
 * 
 */
public final class ArabicNormalizationAnalyzer extends StopwordAnalyzerBase {

  /**
   * File containing default Arabic stopwords.
   * 
   * Default stopword list is from http://members.unine.ch/jacques.savoy/clef/index.html The
   ...
   */
  public ArabicNormalizationAnalyzer(Version matchVersion) {
   ...
   */
  public ArabicNormalizationAnalyzer(Version matchVersion, CharArraySet stopwords) {
    this(matchVersion, stopwords, CharArraySet.EMPTY_SET);
  }

  /**
   * Builds an analyzer with the given stop word. If a none-empty stem exclusion set is provided
   * this analyzer will add a {@link KeywordMarkerFilter} before {@link ArabicStemFilter}.
   * 
   * @param matchVersion lucene compatibility version
   * @param stopwords a stopword set
   ...
   *         {@link ArabicNormalizationFilter}, {@link KeywordMarkerFilter} if a stem exclusion set
   *         is provided and {@link ArabicStemFilter}.
   */
  @Override
  protected TokenStreamComponents createComponents(String fieldName, Reader reader) {
    final Tokenizer source =
        matchVersion.onOrAfter(Version.LUCENE_31)
            ...
            : new ArabicLetterTokenizer(matchVersion, reader);
