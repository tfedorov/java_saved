package com.tfedorov.social.stemming;
...
public class TestStemmingPerformance {
  ...
  public static void setup() {
    ...
    stemmingService.stemWithoutHistory("ambreléa", "fr");
  }
  ...
  public void testWordStemmingPerformanceWithEtmMonitor() {
    ...
    for (int i = 0; i < testCount; i++) {
      for (int j = 0; j < words.length; j++) {
        ...
        stemmingService.stemWithoutHistory(words[j], sentenceLanguage);
        p.collect();
      }
    }
  }
